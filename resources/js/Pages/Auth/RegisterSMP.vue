<template>
    ...
    <Head title="Signup" />
    <header class="d-flex d-md-none align-items-center p-3 w-100 text-white" style="background-color: #161D6F;">
    ...
    <div class="d-flex flex-column vh-100 justify-content-center align-items-center my-5 mx-lg-5">
        ...
        <div  class="w-75 d-flex flex-column gap-4 mt-5">
            ...
            <div class="d-flex flex-column gap-2">
                <n-button type="info" color="#161D6F" size="large" attr-type="submit" @click="handleRegister">Daftar SMP</n-button>
