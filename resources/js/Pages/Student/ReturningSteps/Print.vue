        ...
        <div style="width:100%" class="mx-auto">
            ...
            <div class="d-flex gap-2 align-items-center justify-content-center my-4 ">
                ...
                <button class="btn btn-success"
                    v-if="$page.props.auth.user.student.student_info.returning_step_status == false"
            ...
            <div class="w-100 d-none d-sm-flex align-items-center justify-content-center">
                <div id="download-kartu">
                    <div class="p-2 mx-auto" style="border: 8px solid orange; border-radius: 20px">
...
function handleDone() {
    router.post(route('returning.returning-update'), null, {
        onSuccess: () => {
